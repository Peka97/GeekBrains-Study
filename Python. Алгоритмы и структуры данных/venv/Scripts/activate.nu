...
let virtual-env = "D:\GitHub\GB\Python. Алгоритмы и структуры данных\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\GitHub\GB\Python. Алгоритмы и структуры данных\venv\Scripts\deactivate.nu"
